...
urlpatterns = [
    ...
    path ('rasorpay/<int:order_id>/<str:status>/<str:state>/',views.rasorpay,name='rasorpay'),
    path('verify_payment/<int:order_id>/<str:status>/', views.verify_payment, name='verify_payment'),
    path('rasorpay_order_status/<int:order_id>/<str:state>/', views.rasorpay_order_status, name='rasorpay_order_status'),
    ...
    path('invoice/<int:order_id>/<str:state>/',views.invoice_pdf_view,name='invoice'),
